...
#Testing for ONE species using SAVGOL Method
#Plotting subplots (one per molecular species)
#For species #6 (methanol) 
Fprom = Fprom7
Iprom = Iprom7
flatten_lc1, trend_lc1 = flatten(Fprom, Iprom, window_length=20, return_trend=True, method='savgol') #detrending
flatten_lc2, trend_lc2 = flatten(Fprom, Iprom, window_length=25, return_trend=True, method='savgol') #detrending
flatten_lc4, trend_lc4 = flatten(Fprom, Iprom, window_length=30, return_trend=True, method='savgol') #detrending
flatten_lc5, trend_lc5 = flatten(Fprom, Iprom, window_length=35, return_trend=True, method='savgol') #detrending

fig = plt.figure(figsize = (12,8))
plt.plot(Fprom, Iprom, color='gray', linewidth=2)
plt.plot(Fprom, trend_lc1, linewidth=1, color='red', label='Window length=20') #flattened curve 
plt.plot(Fprom, trend_lc2, linewidth=1, color='green', label='Window length=25') #flattened curve  
plt.plot(Fprom, trend_lc4, linewidth=1, color='blue', label='Window length=30') #flattened curve 
plt.plot(Fprom, trend_lc5, linewidth=1, color='purple', label='Window length=35') #flattened curve 

plt.title('Trends for Methanol 4955.2000 MHz')
plt.xlabel('Frequency (MHz)')
plt.ylabel('I_mean (Jy)')
plt.legend()
...
plt.plot(Fprom, flatten_lc1, linewidth=1, color='red') #flattened curve  
plt.plot(Fprom, flatten_lc2, linewidth=1, color='green') #flattened curve
plt.plot(Fprom, flatten_lc4, linewidth=1, color='blue') #flattened curve  
plt.plot(Fprom, flatten_lc5, linewidth=1, color='purple') #flattened curve 

#plt.savefig('SpectroscopyAnalysis.png', dpi=170) #Saving image

fig = plt.figure(figsize = (12,8))
plt.plot(Fprom, Iprom, color='gray', linewidth=2)
plt.plot(Fprom, trend_lc4, linewidth=1, color='red') #flattened curve
plt.plot(Fprom, trend_lc4, linewidth=1, color='blue') #flattened curve 
plt.plot(Fprom, trend_lc5, linewidth=1, color='purple') #flattened curve 
